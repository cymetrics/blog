...
## 前言
<!-- summary -->
收集與整理資料出有用的資料是很花時間的，如果沒有把這些換成錢駭客們可是會餓死的，所以這篇文章以謀利的角度，舉一些常見的例子來說明駭客如何利用外流的資料與對應的影響，想不在網路上留下任何資料非常困難，所以最後提供一些防範方式與建議供讀者們參考。
<!-- summary -->
___

## 網路上常外流的資料

先假設世界充滿惡意，拿到個資後都是為了惡意用途，但很多狀況下是不得不留下資料，最常見就是申請帳號才能使用某些服務，但申請帳號有一堆必填的欄位，個人資料就這樣出去了。

除了個資之外，還有一些系統資訊常常在不自覺的狀況下外流，最常見的就是 Google 提供的廣告，當你發現廣告內容與你越來越相關，甚至在一些外文的網站看到中文廣告時，代表你的資料早已外流，大家都認識你了 ! 而且隨著外流的資訊量越多廣告也會越加精準。

綜上所述外流的資料可分為 2 大類，分別是個人資料與系統資訊，下面列出一些常見的資料，以防文章在提到個人資料或系統資料時對內容定義的混亂。
...
資料外流的例子有非常多，根據 IC3(FBI 旗下的組織，美國最大的資安通報系統)提供的報告，在 2020 年造成金額損失最多的網路犯罪是 BEC/EAC(透過電子郵件對匯款或付款資訊進行詐騙)，細節可參考之前整理的另一篇文章([資安弱點會造成多大損失](https://hackmd.io/UWP4ExofQ7mG3DqrZOSrng))，因此這邊除了說明影響類ㄓㄧㄥ也以電子郵件為例來說明資料外流後可能會發生的狀況，並且找一個真實案例的新聞來幫助大家了解在現實生活中這些事情如何發生。
...
* **瀏覽紀錄**
    ...
    部分網站除了記錄你的瀏覽資訊之外，還把這些資料送給其他網站，以下圖為例，聯合新聞網將你看了哪些新聞的資訊告訴了送多地方，其中之一是廣告商 Scupio 酷比聯播網，這些資訊也可以在 DevTools 中找到。
...
個人資料中最優先保護的是與付款有關的資料(ex. 信用卡)，如果需要在網路上留下付款資料，最好先確認該服務有沒有支援多要素驗證，雖然多要素驗證多一個步驟使用上比較麻煩，但對駭客來說更麻煩，當麻煩到會放棄攻擊你的程度，就證明這個防護方式是很有用的。

系統資料中最優先保護的是 IP，是一般用戶預設使用浮動 IP 所以就算外流影響也不大，因為較難靠浮動 IP 連到你的電腦，所以除非你已經做好保護，否則盡量避免為了自架服務而改用固定 IP，讓駭客無法找上門就不用擔心門被攻破。

網站的話資料外流的方式比較多樣，除了示範的方法之外還有非常多，建議先以自動化的工具進行檢測，優先確認外流的資料是否與已知的高風險弱點有關，有的話需要盡快修正與更新，如果無法立刻修正在想辦法至少把版本資訊藏起來。
