// source: https://github.com/chromeos/static-site-scaffold-modules/blob/main/modules/markdown-it-figure/index.js
/**
...
function figureRenderer(md) {
  return function figureRender(tokens, idx) {
    ...
    const figcaption = all.figcaption ? `<figcaption>${all.figid ? '<span class="figure-id">' + all.figid + ': </span>' : ''}${md.render(all.figcaption)}</figcaption>` : '';
